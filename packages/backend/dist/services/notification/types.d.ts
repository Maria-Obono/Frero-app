 ...
 * - 8.9: Unread count
 */
export type NotificationEventType = 'like' | 'comment' | 'message' | 'follow' | 'mention' | 'friend_request';
export type NotificationReferenceType = 'post' | 'reel' | 'comment' | 'story' | 'chat' | 'user';
/**
 ...
 */
export declare class NoOpPushAdapter implements PushDeliveryAdapter {
    sendPush(_userId: number, _payload: PushPayload): Promise<boolean>;
}
/**
 ...
 */
export declare class NoOpSocketAdapter implements SocketDeliveryAdapter {
...
export interface INotificationPreferenceRepository {
     ...
     */
    getByUserAndEventType(userId: number, eventType: NotificationEventType): Promise<NotificationPreference | undefined>;
    /**
     * Upsert a preference for a user and event type.
     */
    upsert(userId: number, eventType: NotificationEventType, inAppEnabled: boolean, pushEnabled: boolean): Promise<NotificationPreference>;
}
