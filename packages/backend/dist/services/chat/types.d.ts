 ...
 */
export declare class NoOpChatSocketAdapter implements ChatSocketAdapter {
...
export declare const MAX_MEDIA_SIZE_BYTES: number;
/** Minimum participants for a chat (Requirement 7.9) */
export declare const MIN_PARTICIPANTS = 2;
/** Maximum participants for a group chat (Requirement 7.9) */
export declare const MAX_PARTICIPANTS = 100;
/** Valid message types (Requirement 7.6) */
export declare const VALID_MESSAGE_TYPES: MessageType[];
